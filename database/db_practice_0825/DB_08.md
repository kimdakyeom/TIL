...
for dir in movies:
    if dir.director.name == '봉준호':
        print(dir.director.name, dir.genre.title, dir.title, dir.opening_date, dir.running_time, dir.screening)
```
...
for movie in movies:
    if movie.director.name == '봉준호':
        b_movies.append(movie)

b_movie = b_movies[1]
print(b_movie.director.name, b_movie.genre.title, b_movie.title, b_movie.opening_date, b_movie.running_time, b_movie.screening)
```
...
for movie in movies:
    if movie.director.name == '봉준호' and movie.genre.title == '드라마':
        print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
